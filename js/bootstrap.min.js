    ...
    b.prototype.show=function() {
        if(!this.transitioning&&!this.$element.hasClass("in")) {
            ...
            if(this.$element.trigger(b), !b.isDefaultPrevented()) {
                ...
                a.proxy(f,
                this)).emulateTransitionEnd(350)[e](this.$element[0][g])
            }
        }
    }
    ,
...
+function(a) {
    ...
    b.prototype.backdrop=function(b) {
        ...
        if(this.isShown&&this.options.backdrop) {
            ...
            !b)return;
            d?this.$backdrop.one(a.support.transition.end,
...
+function(a) {
    ...
    b.prototype.show=function() {
        ...
        if(this.hasContent()&&this.enabled) {
            ...
            var q=this.getCalculatedOffset(e,
            h,
            i,
            j);
    ...
    ,
    b.prototype.applyPlacement=function(b,
    c) {
...
+function(a) {
    ...
    d) {
        ...
        g?f.one(a.support.transition.end,
